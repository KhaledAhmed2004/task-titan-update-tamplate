...
exports.TaskService = exports.getAllTasks = void 0;
...
const CacheHelper_1 = require("../../shared/CacheHelper");
...
//   };
// };
const cache = CacheHelper_1.CacheHelper.getInstance({ ttl: 600 });
const getAllTasks = (query, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const cacheKey = cache.generateCacheKey('tasks', userId || 'guest', JSON.stringify(query));
    // 1️⃣ Try cache first
    ...
    if (userId) {
        promises.push(bookmark_model_1.Bookmark.find({ user: userId }).select('post -_id').lean());
    }
    ...
    if (!tasks.length) {
        ...
        yield cache.set(cacheKey, emptyResponse, 300);
    ...
    yield cache.setWithTags(cacheKey, finalResponse, ['tasks'], 600);

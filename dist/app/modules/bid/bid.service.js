...
const acceptBid = (bidId, clientId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield bid_model_1.BidModel.findByIdAndUpdate(bid._id, {
            status: bid_interface_1.BidStatus.PAYMENT_PENDING,
        ...
        try {
            yield (0, notificationsHelper_1.sendNotifications)(paymentPendingNotification);
        }
        catch (err) {
            console.error('Failed to send notification for payment pending:', err);
        }
        return {
            bid: Object.assign(Object.assign({}, bid), { status: bid_interface_1.BidStatus.PAYMENT_PENDING }),
            task,
        ...
        throw new ApiError_1.default(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR, `Failed to initiate payment for bid: ${errorMessage}`);
    }
});
